...
Любое дробное число по умолчанию double , любое целое тип int

Создание переменной определённого типа: floatvar = 0.99f // (float)0.99

Вывод: void fun()  
{System.out.println("sth" + var)}

main всегда паблик и статик и войд
